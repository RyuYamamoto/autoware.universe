...
# kashiwanoha
ground_truth_pose = [3801.450439453125, 73711.484375, 19.66559600830078]
ground_truth_orientation = [-0.0006227031153512751, -0.01027899242434909, 0.9711260728067833, -0.2383444563707543]

# haneda
#ground_truth_pose = [87129.1640625, 34563.671875, 40.081363677978516]
#ground_truth_orientation = [-0.009474929465970767, 0.008861355379481793, -0.6026064262948951, 0.7979330443817131]

# narita
#ground_truth_pose = [44455.734375, 59598.80859375, 39.01340866088867]
#ground_truth_orientation = [0.0031583172019437437, 0.004933384548022431, 0.8720250390273673, 0.48942620596404374]

# bs
#ground_truth_pose = [61388.60546875, 56179.58984375, -7.54829740524292]
#ground_truth_orientation = [-0.0019630752407869523, -0.012379731198985415, 0.8874735791343521, 0.4606880912345136]
